...
public class PageObjects extends Xenon {
	...
	public void login(String username, String password) throws Exception {
		...
		new WebDriverWait(driver, Integer.parseInt(Xenon.configProperties.get("DEFAULTTIME")))
		...
		driver.manage()
				.timeouts()
				.implicitlyWait(Integer.parseInt(Xenon.configProperties.get("DEFAULTTIME")), TimeUnit.SECONDS);
...
//			driver.findElement(By.name("pw")).sendKeys(Keys.ENTER);
	...
	public void gotoAccounts() {
		driver.navigate()
				.to("https://ap4.lightning.force.com/lightning/o/Account/list?filterName=Recent");
		timer.pageLoad();
	}
	...
	public void gotoOpportunity() {
		...
		driver.navigate()
				.to("https://ap4.lightning.force.com/lightning/o/Opportunity/list?filterName=Recent");
	...
	public void gotoCampaign() {
		driver.navigate()
				.to("https://ap4.lightning.force.com/lightning/o/Campaign/list?filterName=Recent");
		timer.pageLoad();
		// Verify campaigns page is loaded
		new WebDriverWait(driver, Integer.parseInt(Xenon.configProperties.get("DEFAULTTIME")))
				.until(ExpectedConditions.titleContains("Campaigns"));
		timer.pause(3);
	}
	...
	public void createOpportunity() {
		try {
			...
			driver.findElement(By.xpath("//span[text()='Stage']/../following-sibling::div//a"))
					.click();

			timer.pause(4);
			driver.findElement(By.xpath("//a[contains(text(),'Prospecting')]"))
					.click();
	...
	public void createCampaign(String campaignName, String confType, String status, String expectedRevenue,
			String budgetedCost, String actualCost, String expectedReturn) throws Exception{

//		element.elementToBeClickable(By.xpath("//div[text()='New']/.."));
//		element.click(By.xpath("//div[text()='New']/.."));
		actions.getVisibleElement(By.xpath("//div[text()='New']/.."));
		report.logs("Clicked on New", "Click", "PASS", "createCampaign", screenShotType.BROWSER, "1");
		actions.click(By.xpath("//div[text()='New']/.."));
		timer.pageLoad();

//		textbox.setValue(By.xpath("//span[contains(text(),'Campaign Name')]/parent::label/following-sibling::input"),
//				campaignName);
		actions.enterText(By.xpath("//span[contains(text(),'Campaign Name')]/parent::label/following-sibling::input"),
				campaignName);
...
//				.click();
		actions.scrollToElementAndHighlight(By.xpath("//span[contains(text(),'Active')]/parent::label/following-sibling::input"));
		report.logs("Selected campaign status", "Active", "PASS", "createCampaign", screenShotType.BROWSER, "1");
		actions.click(By.xpath("//span[contains(text(),'Active')]/parent::label/following-sibling::input"));

//		driver.findElement(By.xpath("//span[contains(text(),'Type')]/../following-sibling::div//a"))
//				.click();
		actions.scrollToElementAndHighlight(By.xpath("//span[contains(text(),'Type')]/../following-sibling::div//a"));
		report.logs("Selecting conference type", "Active", "PASS", "createCampaign", screenShotType.BROWSER, "1");
		actions.click(By.xpath("//span[contains(text(),'Type')]/../following-sibling::div//a"));

//		driver.findElement(By.xpath("//a[contains(text(),'" + confType + "')]"))
//				.click();
		actions.click(By.xpath("//a[contains(text(),'" + confType + "')]"));
		report.logs("Selecting conference type", confType, "PASS", "createCampaign", screenShotType.BROWSER, "1");

//		driver.findElement(By.xpath("//span[contains(text(),'Status')]/../following-sibling::div//a"))
//				.click();
		actions.click(By.xpath("//span[contains(text(),'Status')]/../following-sibling::div//a"));
		report.logs("Selecting status", "In Progress", "PASS", "createCampaign", screenShotType.BROWSER, "1");

//		driver.findElement(By.xpath("//a[contains(text(),'" + status + "')]"))
//				.click();
		actions.click(By.xpath("//a[contains(text(),'" + status + "')]"));

		// setting start date
//		element.elementToBeClickable(
//				By.xpath("//span[contains(text(),'Start Date')]/parent::label/following-sibling::div//a"));
		actions.click(By.xpath("//span[contains(text(),'Start Date')]/parent::label/following-sibling::div//a"));
//		element.elementToBeClickable(By.xpath("//button[contains(text(),'Today')]"));
		actions.click(By.xpath("//button[contains(text(),'Today')]"));

		// setting end date
//		element.elementToBeClickable(
//				By.xpath("//span[contains(text(),'End Date')]/parent::label/following-sibling::div//a"));
		actions.click(By.xpath("//span[contains(text(),'End Date')]/parent::label/following-sibling::div//a"));
//		element.elementToBeClickable(By.xpath("//button[contains(text(),'Today')]"));
		actions.click(By.xpath("//button[contains(text(),'Today')]"));
...
//				budgetedCost);
		actions.clearFieldAndEnterText(By.xpath("//span[contains(text(),'Budgeted Cost in Campaign')]/parent::label/following-sibling::input"),
				budgetedCost);
		report.logs("Entered Budgeted Cost in Campaign", budgetedCost, "PASS", "createCampaign", screenShotType.BROWSER,
				"1");

//		textbox.setValue(
//				By.xpath("//span[contains(text(),'Actual Cost in Campaign')]/parent::label/following-sibling::input"),
//				actualCost);
		actions.enterText(By.xpath("//span[contains(text(),'Actual Cost in Campaign')]/parent::label/following-sibling::input"),
				actualCost);
...
//				expectedReturn);
		actions.enterText(By.xpath("//span[contains(text(),'Expected Response')]/parent::label/following-sibling::input"),
				expectedReturn);
		...
		actions.click(By.xpath("(//span[text()='Save']/..)[2]"));
		// element.invisibilityOfElementLocated(By.xpath("(//span[text()='Save']/..)[2]"));

		// failure condition only if campaign name is empty
		if (campaignName.isEmpty()) {
			timer.pause(5);
			report.logs("These required fields must be completed: Campaign Name", "---", "Fail", "createCampaign",
					screenShotType.BROWSER, "1");
		}
		 ...
		 * xpath("//*[contains(text(),'These required fields must be completed: Campaign Name')]"
		 * ))) { report.logs("These required fields must be completed: Campaign Name",
		 * "---", "Fail", "createCampaign", screenShotType.BROWSER,"1"); }
		 * driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		 */
	}

	public void createLeadFromCampaign(String salutation, String firstname, String lastname, String email,
			String mobile, String companyName) throws Exception {

		driver.get("https://ap4.lightning.force.com/lightning/o/Lead/list?filterName=Recent");
		timer.pageLoad();
		// Verify campaigns page is loaded
		new WebDriverWait(driver, Integer.parseInt(Xenon.configProperties.get("DEFAULTTIME")))
				.until(ExpectedConditions.titleContains("Leads"));
		timer.pause(5);
		...
		actions.enterText(By.xpath("//span[contains(text(),'Email')]/../following-sibling::input"), email)
				.waitTime(2)
				.enterText(By.xpath("//span[contains(text(),'Phone')]/../following-sibling::input"), mobile);
	...
	public void convertLeadToOpportunity(String leadName) throws Exception {
		...
		actions.getVisibleElement(By.xpath("//h1[contains(.,'" + leadName + "')]"));
		report.logs("Lead Name", leadName, "PASS", "convertLeadToOpportunity", screenShotType.BROWSER, "1");

		actions.getVisibleElement(By.xpath("//button[contains(text(),'Convert')]/.."));
		report.logs("Convert Button", "---", "PASS", "convertLeadToOpportunity", screenShotType.BROWSER, "1");
		actions.click(By.xpath("//button[contains(text(),'Convert')]/..")).waitTime(2);

		actions.getVisibleElement(By
		...
		if (actions.getVisibleElement(By.xpath("//*[contains(text(),'Your lead has been converted')]")) != null) {
	...
	public void createQuoteFromOpportunity(String quoteName) {
		...
		report.logs("Open opportunity", "Jade Global Softwares Pvt. Ltd.-", "PASS", "Create Quote From Opportunity",
				screenShotType.BROWSER, "1");
		...
		textbox.setValue(By.xpath("//span[contains(text(),'Quote Name')]/../following-sibling::input"), quoteName);
		report.logs("Entered name for New Quote", quoteName, "PASS", "Create Quote From Opportunity",
				screenShotType.BROWSER, "1");
	}
	...
	public void verificationCheck(String leadName) {
		...
		try {
			...
			if (!element.isDisplayed(searchedResult)) {
				// report.logs("","---", "FAIL", "verificationCheck",
				// screenShotType.BROWSER,"1");
	...
	public void logOutOfApplication(WebDriver driver) {
		try {
			...
			driver.findElement(By.xpath("//img[contains(@id,'_UIScmil2u')]/.."))
					.click();
			...
			driver.findElement(By.xpath("//a[contains(.,'Sign Out')]"))
					.click();
			timer.pageLoad();
